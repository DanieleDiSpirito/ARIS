...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--metodo", "-m", 
        type=str, 
        choices=["euristico", "docling", "llamaparse", "qwen", "pdf4llm", "mineru", "all"],
        default="docling",
        help="Metodo di estrazione da elaborare (euristico, docling, llamaparse, qwen, pdf4llm, mineru, all)."
    )
    args = parser.parse_args()
    
    metodi_disponibili = ["euristico", "docling", "llamaparse", "qwen", "pdf4llm", "mineru"]
